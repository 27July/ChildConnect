...
const ChatPage = ({ route }) => {
  ...
  const { chatData } = route.params || {}; // ✅ Get chat data from navigation
  ...
  return (
    ...
    >
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>{chatData?.name || "Chat"}</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  theirMessage: {
    ...
    backgroundColor: "#7AA9A6", // One more shade darker
  },
  messageText: {
    fontSize: 14,
    color: "#fff",
